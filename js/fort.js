var Fort = {
    ...
    solid: function solid(hex) {
        Fort.clean();
        // var box = document.querySelectorAll(".mts2-section-form__form-wrapper");
        // box.insertAdjacentHTML("beforeBegin", '<div class="top-one" id="top1"><div class="colors"></div></div>');
